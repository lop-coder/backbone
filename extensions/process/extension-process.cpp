...
class ProcessTaskImpl : public ProcessTask,
 ...
 public:
  ...
  virtual void start(
      const std::string& cmd, std::function<void(int exitCode)> finishFunc,
      std::function<void(std::string msg)> stdoutFunc,
      std::function<void(std::string msg)> stderrFunc) final override;
 ...
 private:
  ...
  std::function<void(int exitCode)> _finishFunc;
  std::function<void(std::string msg)> _stdoutFunc;
  std::function<void(std::string msg)> _stderrFunc;
};
...
void ProcessTaskImpl::start(const std::string& cmd,
                            std::function<void(int exitCode)> finishFunc,
                            std::function<void(std::string msg)> stdoutFunc,
                            std::function<void(std::string msg)> stderrFunc) {
